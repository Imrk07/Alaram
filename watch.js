...
let Ringtone1 = new Audio("ringtone1.mp3");
let Ringtone2 = new Audio("ringtone2.mp3");
let Ringtone3 = new Audio("ringtone3.mp3");
...
function setRingtone() {
  ...
  btn2.onclick = function () {
    ...
    btn1.classList.remove("ringtone-btn-select");F
    btn3.classList.remove("ringtone-btn-select");
...
function checkAlarm() {
  ...
  if (currentHours == Hour && currentMinutes == Minute && currentMeridian == Meridian) {
    ...
    Ringtone.play();
    Ringtone.loop = true;
    lowerContainer.classList.add('wave1.gif');
    setTimeout(() => {
      Ringtone.pause();
      AlarmSetFlag = 0;
      lowerContainer.classList.remove('wave1.gif');
...
let buttonSound = new Audio('button-press.mp3');
